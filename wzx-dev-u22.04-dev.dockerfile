...
# docker build -t wzx-dev:u22.04 -f wzx-dev-u22.04-dev.dockerfile .
# docker run -it --name dev --gpus all --shm-size 16G --privileged=true -p 22:22 -p 80:80 -p 443:443 -p 8080:8080 -v $PWD:/root/Workspace wzx-dev:u22.04 /bin/bash